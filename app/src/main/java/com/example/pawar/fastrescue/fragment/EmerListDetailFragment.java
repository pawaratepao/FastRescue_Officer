...
public class EmerListDetailFragment extends Fragment {
    final String commit_URL = "http://pohtecktung.welovepc.com/newproject/android/accept.php";
    final String cancal_URL = "http://pohtecktung.welovepc.com/newproject/android/cancelrub.php";
    Button btcommitre,btcancalre,btphoto;
    TextView tv_alert_event;
    TextView tv_alert_detail;
    ImageView alert_image;
    String noti_id, username,url;
    ...
    public void sendCommit() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, commit_URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Intent actintent = new Intent(getActivity(), OfficialActivity.class);
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("official_id", username);
    ...
    public void emertofile() {
        ...
        if (check == null) {
            ...
            editor.putString("noti_id", dao.getNotiId());
            editor.putString("noti_latitude", dao.getNotiLatitude());
            editor.putString("noti_longtitude", dao.getNotiLongitude());
            ...
            editor.putString("emer_user",dao.getNotiUser());
            editor.putString("emer_off",dao.getNotiOfficial());
