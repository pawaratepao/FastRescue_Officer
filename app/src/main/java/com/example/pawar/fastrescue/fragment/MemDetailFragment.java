...
import com.example.pawar.fastrescue.activity.EditDetailActivity;
import com.example.pawar.fastrescue.activity.EquipmentActivity;
import com.example.pawar.fastrescue.activity.NewsActivity;


public class MemDetailFragment extends Fragment {
    Button btedit,bteqiup;
    ...
    private void initInstances(View rootView) {
        ...
        bteqiup = (Button) rootView.findViewById(R.id.bteqiup);
        bteqiup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
