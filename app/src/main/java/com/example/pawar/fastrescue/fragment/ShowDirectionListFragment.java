...
public class ShowDirectionListFragment extends Fragment implements OnMapReadyCallback {
    ...
    public ShowDirectionListFragment() {
        super();
    }

    public static ShowDirectionListFragment newInstance(EmerItemDao dao) {
        ShowDirectionListFragment fragment = new ShowDirectionListFragment();
                    ...
                    public void onDirectionSuccess(Direction direction, String rawBody) {
                        if (direction.isOK()) {
                            mMap.addMarker(new MarkerOptions().position(origin).icon(BitmapDescriptorFactory
                                    .defaultMarker(BitmapDescriptorFactory.HUE_GREEN)).title("ที่เอยู่ปัจจุบัน")).showInfoWindow();
