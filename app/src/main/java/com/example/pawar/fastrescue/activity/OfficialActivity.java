...
import com.example.pawar.fastrescue.fragment.HomeOfficialFragment;
import com.example.pawar.fastrescue.service.LocationService;
import com.example.pawar.fastrescue.service.OnlineLocationService;
...
public class OfficialActivity extends AppCompatActivity implements HomeOfficialFragment.HomeOffFragmentListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    final String online_URL = "http://pohtecktung.welovepc.com/newproject/android/online.php";
    final String offline_URL = "http://pohtecktung.welovepc.com/newproject/android/offline.php";
    final String check_URL = "http://pohtecktung.welovepc.com/newproject/android/returnStatus.php";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.equipedit) {
...
//what you want to do
    ...
    public void sendDataOnline() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, online_URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("official_longitude", lng);
    ...
    public void startService() {
        Intent intent = new Intent(this, OnlineLocationService.class);
        startService(intent);
    }
