...
import com.example.pawar.fastrescue.fragment.TabEmerFragment;
import com.example.pawar.fastrescue.manager.ActivityResultBus;
import com.example.pawar.fastrescue.manager.ActivityResultEvent;
...
public class EmergencyActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, EmergencyFragment.EmergencyFragmentListener {
    private static final String URL = "http://pohtecktung.welovepc.com/newproject/android/upload_detail_official.php";
    Toolbar toolbar;
