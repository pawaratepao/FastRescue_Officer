package com.example.pawar.fastrescue.view;
...
import com.example.pawar.fastrescue.view.state.BundleSavedState;
...
public class NewsListItem extends BaseCustomViewGroup {
    ...
    public void setNewsName(String text){
        newsName.setText(text);
    }

    public void setNewsDetail(String text){
        newsDetail.setText(text);
    }
    public void setNewsURL(String url){
        Glide.with(getContext())
                .load("http://pohtecktung.welovepc.com/newproject/img/img_news/"+url)
